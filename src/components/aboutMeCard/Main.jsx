...
import "../aboutMeCard/Main.css";

export default function Main() {
  return (
    <div className="main--container">
      <h3 className="main--heading main--content">Ahmad Jahangiry</h3>
      ...
      <div className="main--about--interest">
        ...
        <p>
          ...
          optio beatae magnam. Sequi eius eligendi, quis repellendus nihil,
          libero ab nobis soluta odit tempore autem ut obcaecati maxime.
          Molestias!
        </p>
        <h3>Interests</h3>
        <p>
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Enim, vero.
          Dignissimos ratione ipsam pariatur laudantium iusto sunt aliquam ea
          assumenda neque, facilis officiis cupiditate ipsum saepe, maxime
          debitis quas quidem!
        </p>
      </div>
    </div>
